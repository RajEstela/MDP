...
The robot always starts in the **bottom-left corner** (the "start zone"), specifically at position **(25 cm, 25 cm)** — the robot's body **center** (the point the software tracks, since the real car turns about its own center, not its front tip) when its bottom-left wheel edge sits at (10 cm, 10 cm), per live-hardware calibration (starting flush at (0,0) was too tight for the real car).
...
| `START_X_CM` | 25 | Robot's center starts 25 cm from left wall |
| `START_Y_CM` | 25 | Robot's center starts 25 cm from bottom wall |
...
*"The robot's center is 25 cm from the left, 25 cm from the bottom, and facing North."* That's the starting position.
...
1. **Start** the robot at (25, 25) facing North.
...
| Robot start | (25 cm, 25 cm), facing 90° (North) |
